...
class ArticlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articl" do
    assert_difference('Articl.count') do
      post articls_url, params: { articl: { description: @articl.description, text: @articl.text, title: @articl.title } }
    end
  ...
  test "should update articl" do
    patch articl_url(@articl), params: { articl: { description: @articl.description, text: @articl.text, title: @articl.title } }
